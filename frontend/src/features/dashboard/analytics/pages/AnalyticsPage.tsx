import { ActivityIcon, BarChart3, Briefcase, CheckCircle, XCircle } from "lucide-react";
...
export function AnalyticsPage() {
    ...
    return (
        <section className="min-h-screen p-6">
            ...
            <section className="max-w-8xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
            ...
            <section className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-4 mt-6">
                <WeeklySentChart />
                <WeeklySentChart />
            </section>
